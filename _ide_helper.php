...
namespace {
    ...
    class Cache extends \Illuminate\Support\Facades\Cache{
         ...
         *
         * @return \LemonTree\CustomFileStore 
         * @static 
         */
        ...
        public static function increment($key, $value = 1){
            \LemonTree\CustomFileStore::increment($key, $value);
        }
        ...
        public static function decrement($key, $value = 1){
            \LemonTree\CustomFileStore::decrement($key, $value);
        }
        ...
        public static function forever($key, $value){
            \LemonTree\CustomFileStore::forever($key, $value);
        }
        ...
        public static function forget($key){
            \LemonTree\CustomFileStore::forget($key);
        }
        ...
        public static function flush(){
            \LemonTree\CustomFileStore::flush();
        }
        ...
        public static function getFilesystem(){
            return \LemonTree\CustomFileStore::getFilesystem();
        }
        ...
        public static function getDirectory(){
            return \LemonTree\CustomFileStore::getDirectory();
        }
        ...
        public static function section($name){
            ...
            return \LemonTree\CustomFileStore::section($name);
        }
        ...
        public static function tags($names){
            //Method inherited from \Illuminate\Cache\TaggableStore            
            return \LemonTree\CustomFileStore::tags($names);
        }
