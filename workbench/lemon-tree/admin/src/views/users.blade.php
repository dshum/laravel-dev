...
<table class="element-list">
	<tr>
		...
		<th>Создана</th>
		<th>Обновлена</th>
		<th><img src="{{ asset('packages/lemon-tree/admin/img/delete-title.png') }}" alt="" /></th>
	</tr>
	@foreach ($groupList as $group)
	<tr>
		<td class="first"><a href="{{ URL::route('admin.users.group', $group->id) }}"><img src="{{ asset('packages/lemon-tree/admin/img/file.png') }}" alt="" style="vertical-align: middle;" /></a></td>
		<td><img src="{{ asset('packages/lemon-tree/admin/img/edit.png') }}" alt="" style="vertical-align: middle; margin-right: 5px;" /><a href="{{ \URL::route('admin.group', $group->id) }}">{{ $group->name }}</a></td>
		...
		<td><a href="{{ \URL::route('admin.group.delete', $group->id) }}" class="btn"><img src="{{ asset('packages/lemon-tree/admin/img/delete.png') }}" alt="" /></a></td>
	</tr>
	@endforeach
</table>
@endif
...
@foreach ($userList as $user)
	<tr>
		<td class="first"><a href="{{ URL::route('admin.users.user', $user->id) }}"><img src="{{ asset('packages/lemon-tree/admin/img/file.png') }}" alt="" style="vertical-align: middle;" /></a></td>
		<td><img src="{{ asset('packages/lemon-tree/admin/img/edit.png') }}" alt="" style="vertical-align: middle; margin-right: 5px;" /><a href="{{ \URL::route('admin.user', $user->id) }}">{{ $user->login }}</a></td>
		<td>{{ $user->email }}</td>
	...
	@endif
		...
		<td><a href="{{ \URL::route('admin.user.delete', $user->id) }}" class="btn"><img src="{{ asset('packages/lemon-tree/admin/img/delete.png') }}" alt="" /></a></td>
	</tr>
@endforeach
</table>
