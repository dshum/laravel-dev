...
Тип операции:<br />
<select name="action_type" class="prop-select">
...
<div class="prop-search">
Дата операции:<br />
от <input type="text" class="prop-date" id="date_from" name="date_from" value="{{ $dateFrom ? $dateFrom->format('Y-m-d') : null }}"> <span id="date_from_show" class="hand"><img src="{{ asset('packages/lemon-tree/admin/img/calendar.gif') }}" alt="" /></span>
до <input type="text" class="prop-date" id="date_to" name="date_to" value="{{ $dateTo ? $dateTo->format('Y-m-d') : null }}"> <span id="date_to_show" class="hand"><img src="{{ asset('packages/lemon-tree/admin/img/calendar.gif') }}" alt="" /></span><br />
</div>
<br clear="both" />
</div>
